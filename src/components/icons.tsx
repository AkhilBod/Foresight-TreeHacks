...
export const BrainIcon = ({ size = 24, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 2C9 2 7 4 7 6.5c0 .5.1 1 .3 1.5C5.3 8.5 4 10 4 12c0 1.5.7 2.8 1.7 3.7C5.3 16.5 5 17.5 5 18.5 5 20.4 6.6 22 8.5 22c1 0 2-.4 2.7-1.2.2.1.5.2.8.2s.6-.1.8-.2C13.5 21.6 14.5 22 15.5 22c1.9 0 3.5-1.6 3.5-3.5 0-1-.3-2-1-2.8 1-.9 1.7-2.2 1.7-3.7 0-2-1.3-3.5-3.3-4C16.9 7.5 17 7 17 6.5 17 4 15 2 12 2z" />
    <path d="M12 2v20" />
    <path d="M7 12h10" />
  </svg>
);
...
export const SlidersIcon = ({ size = 24, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const DeviceIcon = ({ size = 24, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const HelpIcon = ({ size = 24, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
